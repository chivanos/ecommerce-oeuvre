...
import FillingDashboard from './Filling/FillingDashboard';
...
export default function OuevraAdmin(){

   
        return (
            <>
                <Manage 
                    header={<HeaderSecond title={"Dashboard"} />}
                    ...
                    titre={"Home"}
                    composant={<Filling dashboard={<FillingDashboard />}/>}
