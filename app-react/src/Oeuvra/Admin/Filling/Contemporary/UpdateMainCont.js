...
export default function UpdateMainCont(){
    ...
    return (
        <>
            <div className="col-md-12">
                <Manage
                    header={<HeaderSecond title={"Update Contemporary"} />}
                    ...
                    titre={"Update"}
                    composant={<Filling dashboard={<UpdateFilling content={content} url={`http://localhost:8000/api/list/cont/`} />}/>}
