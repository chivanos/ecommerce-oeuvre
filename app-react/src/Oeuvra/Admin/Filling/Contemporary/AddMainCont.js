...
export default function AddMainCont(){    

    return (
        <>
            <div className="col-md-12">
                <Manage 
                    header={<HeaderSecond title={"Contemporary Art"} />}
                    loadhead={<HeaderLeftGenerale />}
                    link={
                        <Link to={"/contemporaryadmin/oeuvra"} className="lie--tw">
                    ...
                    titre={"Add contemporary art"}
                    composant={<Filling dashboard={<AddCont />}/>}
                    image={"../images/img1.jpg"}
                    addlink={<Link to={"/ca/oeuvra/add"} className="lie--tw">
