...
import {useNavigate} from "react-router-dom"
        ...
        export default function UpdateRoy(){
            ...
            const handleSubmit = (e) => 
            {
                ...
                && objet.description != '' && objet.author != '' && objet.country != '')
                {
                    ...
                    axios.post("http://localhost:8000/api/add/roy/admin/oeuvra",formData)
                    .then((response) => {
                ...
                <section className="col-sm-6 offset-sm-3 back--black">
                    <div className="m-5">
                        <form onSubmit={handleSubmit}>
                            <h1 className="">Update Tresuares</h1><br/>
                            ...
                            <input type="text" value={objet.description} onChange={handleChange} name="description" className="form-control mt-2" placeholder="description"/>
