...
import AddRoy from "./AddRoy";
import HeaderSecond from "../../Props/HeaderSecond";
import HeaderLeftGenerale from "../../Props/HeaderLeftGenerale";
import Manage from "../../Manage";


export default function AddMainRoy(){    

    return (
        <>
            <div className="col-md-12">
                <Manage 
                    header={<HeaderSecond title={"Royal tresuares"} />}
                    loadhead={<HeaderLeftGenerale />}
                    link={
                        <Link to={"/royaladmin/oeuvra"} className="lie--tw">
                    ...
                    titre={"Add tresuares royal"}
                    composant={<Filling dashboard={<AddRoy />}/>}
